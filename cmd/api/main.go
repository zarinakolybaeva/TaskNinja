...
import (
	...
	"github.com/zarinakolybaeva/Task/data"
	"github.com/zarinakolybaeva/Task/jsonlog"
	"github.com/zarinakolybaeva/Task/mailer"
...
func main() {
	...
	flag.IntVar(&cfg.port, "port", 2222, "API server port")
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://postgres:postgres@localhost/tables?sslmode=disable", "PostgreSQL DSN")
